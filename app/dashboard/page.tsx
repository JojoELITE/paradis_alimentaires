...
export default function ProduitsPage() {
  ...
  const formattedProducts = products.map((product) => ({
    ...
    // CORRECTION ICI: Vérifier si l'image existe, sinon placeholder
    ...
    <main className="flex min-h-screen flex-col items-center justify-between pt-32">
      <section className="py-16 w-full">
        <div className="container mx-auto px-4">
          ...
          {/* Featured Product - CORRECTION ICI */}
          {featuredProduct && (
            <div className="mb-12">
              <Link href={`/produits/${featuredProduct.id}`} className="block">
                <div className="relative rounded-lg overflow-hidden group">
                  <div className="relative w-full h-[400px]">
                    <Image
                      src={featuredProduct.image_url && featuredProduct.image_url.trim() !== "" 
