  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setCouponSuccess(
          `Coupon "${data.data.coupon.code}" appliqué — vous économisez ${data.data.pricing.discount_amount.toLocaleString()} FCFA !`
        )
        setCouponCode("")
      } else {
        setCouponError(data.message || "Ce coupon est invalide.")
        setAppliedCoupon(null)
      }
    } catch {
      setCouponError("Erreur réseau. Veuillez réessayer.")
      setAppliedCoupon(null)
    } finally {
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <Input
                          ...
                          className={cn(
                            "flex-1 uppercase tracking-widest",
